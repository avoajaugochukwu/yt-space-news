...
- "fact": a source metric was dropped, summarized into a vague term ("a lot", "huge", "many"), a paragraph of source detail collapsed into a single sentence (technical-density failure), OR a fabricated/unverifiable augmentation was inserted (a metric, program, or claim you cannot confirm against current aerospace engineering or documented history).
